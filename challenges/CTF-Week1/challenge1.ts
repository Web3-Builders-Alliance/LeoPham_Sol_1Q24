...
const mint = new PublicKey("AE1Q6cnVFLdcZinoB3HgDnMZb6SCHv887mQFJpvnExyU");
...
(async () => {
  try {
    ...
    console.log(
      `Success! Check out your TX here: https://explorer.solana.com/tx/${completeTx}?cluster=devnet`
    );
  } catch (e) {
